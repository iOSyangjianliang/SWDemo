...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    LeftViewController *leVC = [[LeftViewController alloc] init];
    
    MainViewController *mainVc = [[MainViewController alloc] init];
    UINavigationController *navi = [[UINavigationController alloc] initWithRootViewController:mainVc];
    
    LeftSlideViewController *rootVC = [[LeftSlideViewController alloc] initWithLeftVC:leVC naviVC:navi];
    mainVc.leftVC = rootVC;
    leVC.leftVC = rootVC;
