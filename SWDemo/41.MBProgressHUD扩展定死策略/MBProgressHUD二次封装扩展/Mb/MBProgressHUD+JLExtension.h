...
typedef NS_ENUM(NSInteger, MBProgressHUDDisplayPloy) {
    ...
    MBProgressHUDDisplaySameViewWaiting, //如果展示的toast所在view不同、同时展示在不同view上、如果view相同，则先记录等待上一个展示结束再展示新toast

};
NS_ASSUME_NONNULL_BEGIN

static MBProgressHUDDisplayPloy defaultDisplayPloy = MBProgressHUDDisplayWaitingAndIgnoreSameToast;
